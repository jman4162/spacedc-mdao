...
## Status: Phase 1 + Phase 2 complete; Phase 3A + 3B landed
...
Still to do: 3C (UX/reporting/hygiene: CLI subcommands, py.typed/LICENSE/CHANGELOG, report export, notebook ladder, editable-install fix).
